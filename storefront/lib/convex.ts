...
import { ConvexReactClient, useMutation as convexUseMutation, useQuery as convexUseQuery } from "convex/react";
...
export function useConvexMutation<TArgs extends AnyRecord = AnyRecord, TResult = unknown>(name: string) {
