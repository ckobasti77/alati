...
const fallbackCategories = [
    ...
    },
    {
        id: "poljo",
        label: "Poljoprivreda",
        icon: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$tractor$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Tractor$3e$__["Tractor"], {
            size: 15
        }, void 0, false, {
            fileName: "[project]/storefront/app/page.tsx",
            lineNumber: 22,
...
function StorefrontPage() {
    ...
    const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$convex$2f$dist$2f$esm$2f$react$2f$client$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])("categories:listPublic", {});
    ...
    const categoryOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StorefrontPage.useMemo[categoryOptions]": ()=>{
            const apiCategories = categories?.map({
                "StorefrontPage.useMemo[categoryOptions]": (category)=>({
    ...
    const filteredItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StorefrontPage.useMemo[filteredItems]": ()=>{
            if (selectedCategory === "all") return items;
            const entry = categoryOptions.find({
                "StorefrontPage.useMemo[filteredItems].entry": (c)=>c.id === selectedCategory
            }["StorefrontPage.useMemo[filteredItems].entry"]);
            if (!entry) return items;
            const byCategory = items.filter({
                "StorefrontPage.useMemo[filteredItems].byCategory": (item)=>(item.categoryIds ?? []).includes(selectedCategory)
            }["StorefrontPage.useMemo[filteredItems].byCategory"]);
            if (byCategory.length > 0) return byCategory;
            const keywords = entry.keywords ?? [];
            if (keywords.length === 0) return items;
            const subset = items.filter({
                "StorefrontPage.useMemo[filteredItems].subset": (item)=>{
                    const text = `${item.kpName ?? item.name} ${item.opis ?? ""} ${item.opisFbInsta ?? ""} ${item.opisKp ?? ""}`.toLowerCase();
                    return keywords.some({
                        "StorefrontPage.useMemo[filteredItems].subset": (kw)=>text.includes(kw)
                    }["StorefrontPage.useMemo[filteredItems].subset"]);
                }
            }["StorefrontPage.useMemo[filteredItems].subset"]);
    ...
    const slides = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StorefrontPage.useMemo[slides]": ()=>{
            if (items.length === 0) return [];
            const shuffled = [
                ...items
            ].sort({
                "StorefrontPage.useMemo[slides].shuffled": ()=>Math.random() - 0.5
            }["StorefrontPage.useMemo[slides].shuffled"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StorefrontPage.useEffect": ()=>{
            ...
            const id = setInterval({
                "StorefrontPage.useEffect.id": ()=>{
                    setSlideIndex({
                        "StorefrontPage.useEffect.id": (prev)=>(prev + 1) % slides.length
                    }["StorefrontPage.useEffect.id"]);
                }
            }["StorefrontPage.useEffect.id"], slideIntervalMs);
            return ({
                "StorefrontPage.useEffect": ()=>clearInterval(id)
            })["StorefrontPage.useEffect"];
        }
    }["StorefrontPage.useEffect"], [
        slides
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: categoryOptions.map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "button",
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            currentSlide ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                className: "price",
                                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$storefront$2f$lib$2f$format$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(currentSlide.prodajnaCena)
                                                            }, void 0, false, {
                                                                fileName: "[project]/storefront/app/page.tsx",
                                                                lineNumber: 162,
                                                                columnNumber: 23
...
_s(StorefrontPage, "+G1CwfZ+oArbX4gPT4VDdBRwAeQ=", false, function() {
    return [
...
//# sourceMappingURL=_713c48cf._.js.map